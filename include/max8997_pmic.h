...
enum max8997_reg_mask {
	MAX8997_MASK_LDO = 0xC0,
	MAX8997_MASK_BUCK = 0x1,
	MAX8997_MASK_EN32KHZ = 0x1,
	MAX8997_MASK_ENVICHG = 0x80,
	MAX8997_MASK_ESAFEOUT = 0x40,
	MAX8997_MASK_CHARGER = 0x40,
};

enum max8997_led_regs {
	MAX8997_LED_FLASH_SHIFT = 3,
	MAX8997_LED_FLASH_CUR_MASK = 0xf8,
	MAX8997_LED_MOVIE_SHIFT = 4,
	MAX8997_LED_MOVIE_CUR_MASK = 0xf0,
	MAX8997_LED0_FLASH_MASK = 0x1,
	MAX8997_LED0_FLASH_PIN_MASK = 0x5,
	MAX8997_LED0_MOVIE_MASK = 0x8,
	MAX8997_LED0_MOVIE_PIN_MASK = 0x28,
	MAX8997_LED1_FLASH_MASK = 0x2,
	MAX8997_LED1_FLASH_PIN_MASK = 0x6,
	MAX8997_LED1_MOVIE_MASK = 0x10,
	MAX8997_LED1_MOVIE_PIN_MASK = 0x30,
	MAX8997_LED_BOOST_ENABLE_MASK = (1 << 6),
};
